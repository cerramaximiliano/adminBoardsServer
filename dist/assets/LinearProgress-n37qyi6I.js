import{M,N as q,bE as h,s as m,E as t,ay as s,bF as C,r as j,az as z,aA as D,aa as T,aB as b,aC as U,G as A,av as E,ao as O}from"./index-C2pyM5Ac.js";function K(r){return M("MuiLinearProgress",r)}q("MuiLinearProgress",["root","colorPrimary","colorSecondary","determinate","indeterminate","buffer","query","dashed","dashedColorPrimary","dashedColorSecondary","bar","barColorPrimary","barColorSecondary","bar1Indeterminate","bar1Determinate","bar1Buffer","bar2Indeterminate","bar2Buffer"]);const X=["className","color","value","valueBuffer","variant"];let l=r=>r,$,L,k,B,I,_;const v=4,F=h($||($=l`
  0% {
    left: -35%;
    right: 100%;
  }
